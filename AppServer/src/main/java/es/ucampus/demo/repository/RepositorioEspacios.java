...
public interface RepositorioEspacios extends JpaRepository<Espacio, String>{
    ...
    @Transactional
    @Modifying
    @Query(value="UPDATE public.espaciogeneral SET canyon_fijo = :canyon, pantalla_proyector= :proyector, equipo_de_sonido= :sonido, tv= :tv, video= :video, dvd= :dvd, fotocopiadoras= :fotocopiadora, impresoras= :impresora, ordenadores= :ord, faxes= :fax, telefonos= :tlf, pizarra= :pizarra, nmro_extintores_polvo= :extpol, nmro_extintores_co2= :extco2 WHERE id_espacio = :espacio", nativeQuery = true)
    public int establecerEquipamiento(@Param ("espacio") String espacio, @Param ("canyon") int canyon, @Param ("proyector") int proyector, @Param ("sonido") int sonido, @Param ("tv") String tv, @Param ("video") int video, @Param ("dvd") int dvd, @Param ("fotocopiadora") int fotocopiadora, @Param ("impresora") int impresora, @Param ("ord") int ord, @Param ("fax") int fax, @Param ("tlf") int tlf, @Param ("pizarra") int pizarra, @Param ("extpol") int extpol, @Param ("extco2") int extco2);
